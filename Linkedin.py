...
time.sleep(2)
pword = driver.find_element("xpath",'//*[@id="password"]')  #password xpath to find the password box
pword.send_keys("password") #password  to provide for the password box
time.sleep(2)
driver.find_element('xpath','//*[@id="organic-div"]/form/div[3]/button').click() #button xpath and click function
time.sleep(2)
